...
class TurnDetectionOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_active", b"_active", "_full_utterance_deployment", b"_full_utterance_deployment", "_llm_host", b"_llm_host", "_llm_model_name", b"_llm_model_name", "_llm_port", b"_llm_port", "_llm_request_timeout", b"_llm_request_timeout", "active", b"active", "full_utterance_deployment", b"full_utterance_deployment", "llm_host", b"llm_host", "llm_model_name", b"llm_model_name", "llm_port", b"llm_port", "llm_request_timeout", b"llm_request_timeout"]) -> builtins.bool: ...
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_llm_model_name", b"_llm_model_name"]) -> typing.Literal["llm_model_name"] | None: ...
    @typing.overload
