...
ONDEWO_S2T_VERSION = 4.0.1
ONDEWO_S2T_API_GIT_BRANCH=feature/OND231-390-update-api-due-to-whisper-config-update#tags/4.0.0
...
CURRENT_RELEASE_NOTES=`cat RELEASE.md \
	| sed -n '/Release ONDEWO S2T Python Client ${ONDEWO_S2T_VERSION}/,/\*\*/p'`
...
update_setup: ## Update S2T Version in setup.py
...
create_conda_env: ##Creates CONDA Environment
	conda create -y --name ondewo-s2t-client-python python=3.8
