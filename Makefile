...
# 3 - make update_setup
#
# Fully automated build and deploy process for ondewo-s2t-client-python
...
# Choose the submodule version to build ondewo-s2t-client-python
...
# Choose repo to release to - Example: "https://github.com/ondewo/ondewo-s2t-client-python"
